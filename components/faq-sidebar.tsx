          ...
          return (
            <li key={cfg.slug}>
              <button
                ...
                className={cn(
                  'focus-visible:ring-primary/60 w-full rounded-lg px-3.5 py-2.5 text-left text-sm transition-colors duration-150 focus-visible:ring-2 focus-visible:outline-none',
                  isActive
