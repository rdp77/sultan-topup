    ...
    <form onSubmit={handleSubmit} className="space-y-5" noValidate>
      ...
      <div>
        ...
        <input
          ...
          autoComplete="name"
        />
        {nameError && <p className="text-destructive mt-1.5 text-xs">{nameError}</p>}
      </div>
      ...
      <div>
        ...
        {subjectError && <p className="text-destructive mt-1.5 text-xs">{subjectError}</p>}
      </div>
      ...
      <div>
        ...
        <textarea
          ...
          disabled={isPending}
        />
        {bodyError && <p className="text-destructive mt-1.5 text-xs">{bodyError}</p>}
      </div>
      ...
      <button
        type="submit"
        disabled={isPending}
        className="press bg-primary text-primary-foreground hover:bg-primary/90 inline-flex w-full items-center justify-center gap-2 rounded-lg px-6 py-3 text-sm font-semibold transition-colors duration-200 disabled:cursor-not-allowed disabled:opacity-50"
      >
        {isPending ? (
          <>
