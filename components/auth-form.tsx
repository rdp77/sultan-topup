    ...
    <div className="mx-auto w-full max-w-sm">
      <div className="flex flex-col items-center text-center">
        ...
        <h1 className="mt-4 text-2xl font-bold tracking-tight">
          {isLogin ? 'Masuk ke TopUpin' : 'Buat Akun TopUpin'}
        </h1>
      ...
      <form onSubmit={handleSubmit} className="mt-8 flex flex-col gap-4">
        ...
        <button
          type="submit"
          disabled={loading}
          className="mt-2 flex w-full items-center justify-center gap-2 rounded-md bg-primary px-6 py-3 text-sm font-semibold text-primary-foreground transition-all duration-200 enabled:hover:scale-[1.02] enabled:hover:shadow-[0_0_20px_rgba(99,102,241,0.4)] disabled:opacity-60"
        >
          {loading ? (
            <>
